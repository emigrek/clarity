...
function NavItem({ to, Content, active}) {
    ...
    return (
        <div
            ...
            className={ active ? 
                "flex w-14 md:w-56 justify-center items-center py-3 bg-opacity-100 transition duration-150 cursor-pointer backdrop-blur-md bg-white text-black hover:bg-white hover:text-black rounded-lg" 
                : 
